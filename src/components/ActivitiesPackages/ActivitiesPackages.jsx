...
const ActivitiesPackages = () => {
  return (
    <div className='px-[169px] py-14 flex flex-col gap-8'>
        <div className='flex justify-between'>
            <div className='w-[40%]'>
                <p className='font-[Merriweather_Sans] border-l-[3.5px] border-[#CA1C26] pl-3 uppercase text-[24px] font-bold tracking-wider'>Explore Our <br /> Best <span className='text-[#CA1C26]'>Activities Packages</span></p>
            </div>
            <div className='w-[43%]'>
        ...
        <div className='grid grid-cols-3 gap-3'>
            <div className='activity-card1 h-[600px] flex font-[Merriweather_Sans] flex-col justify-end text-white rounded-md px-4 py-6 relative overflow-hidden'>
                <div className='relative z-10 flex items-center'>
                    ...
                    <img src='/Assets/Icons/activityleaf.svg' alt='' />
                </div>

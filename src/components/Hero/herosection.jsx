    ...
    return (
        <div className={`font-[Merriweather_Sans] ${styles.hero_section}`} style={{backgroundImage: 'url(/Assets/Images/hero_banner.jpg)'}}>
            ...
            <div className="flex flex-col w-full h-full items-center pt-28 text-white">
                ...
                <div className={`px-5 z-[9999] ${activeFacility === "Tour" ? 'w-[50%]' : activeFacility === "Activities" ? 'w-[50%]' : activeFacility === "Flight" ? 'w-[60%]' : 'w-[60%]'} `} ref={searchRef}>
                    {activeFacility === "Tour" &&
                        (Search ?
                            <div className='bg-[#F6F6F6] rounded-t-3xl rounded-b flex flex-col shadow-lg shadow-[#00000021]'>
                                <input className='w-full text-[#000000] placeholder:text-[#848383] bg-[#F6F6F6] flex justify-center text-[14px] rounded-full pl-16 py-2 shadow-sm shadow-[#00000021] outline-none' placeholder='Search For Destinations...' />
                                <div className='px-16 py-4'>
                                    ...
                                    <div className='pt-2 flex justify-end'>
                                        <button className='bg-[#CA1C26] text-white uppercase font-int text-[14px] px-4 py-[6px] rounded-sm hover:border hover:border-dotted xsm:text-[13px] xsm:px-7 xsm:py-[6px]'>Search For Trip</button>
                                    </div>
                                </div>
                            </div>
                            :
                        ...
                        <div className='bg-[#F6F6F6] rounded-md flex items-center shadow-lg shadow-[#00000021] '>
                            <div className='grid grid-cols-4 items-center py-3 w-full px-5'>
                                <div className='border-r border-[#01008036] py-1 cursor-pointer relative'>
                                    <div onClick={() => setLocationFilter(!locationFilter)} className='flex items-center gap-1'>
                                        <img className='w-6 h-6' src={'/Assets/Icons/herolocation.svg'} alt="" />
                                        <div>
                                            <p className='text-[#000000] text-[12.5px]'>Location</p>
                                            <p className='text-[#9E9E9E] text-[10px]'>Where Are You Going ?</p>
                                        </div>
                                    </div>
                                    {locationFilter ?
                                ...
                                <div className='border-r border-[#01008036] py-1 cursor-pointer relative'>
                                    <div onClick={() => setactivityDate(!ActivityDate)} className='flex items-center justify-center gap-1'>
                                        <img className='w-6 h-6' src={'/Assets/Icons/HeroDate.svg'} alt="Date Icon" />
                                        <div>
                                    ...
                                    {ActivityDate &&
                                        <div className='absolute bg-[#F6F6F6] text-[#000] top-[100%] left-0  rounded-md shadow-lg shadow-[#00000021]'>
                                            <DayPicker mode="single" selected={selected} onSelect={setSelected} className='' />
                                        </div>
                                    }
                                </div>
                                <div className='py-1 cursor-pointer relative'>
                                    <div onClick={() => setPersonFilter(!personcntFilter)} className='flex items-center justify-center gap-1 '>
                                        <img className='w-6 h-6' src={'/Assets/Icons/HeroBag.svg'} alt="" />
                                        <div>
                                            <p className='text-[#000000] text-[12.5px]'>No. of Person</p>
                                            <p className='text-[#9E9E9E] text-[10px]'>2 Adult 1 Child</p>
                                        </div>
                                    </div>
                                    {personcntFilter &&
                                            ...
                                            <div className='flex justify-between items-center'>
                                                ...
                                                <div className='flex items-center gap-2'>
                                                    <div className='bg-[#FFFFFF] rounded-full p-1'>
                                                        <img className='w-3 h-3' src={'/Assets/Icons/Herominus.svg'} alt="" />
                                                    </div>
                                                    <p className='text-[#000000] text-[16px]'>1</p>
                                                    <div className='bg-[#FFFFFF] rounded-full p-1'>
                                                        <img className='w-3 h-3'  src={'/Assets/Icons/Heroplus.svg'} alt="" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className='flex justify-between items-center'>
                                ...
                                <div className='w-full flex justify-end'>
                                    <button className='bg-[#CA1C26] text-white uppercase font-int text-[12px] px-3 py-[6px] rounded hover:border hover:border-dotted xsm:text-[13px] xsm:px-7 xsm:py-[6px]'>Search Now </button>
                                </div>
                            </div>
                        </div> 
                    }
                    ...
                    {activeFacility === "Flight" &&
                        <div className='bg-[#F6F6F6] rounded-md flex items-center shadow-lg shadow-[#00000021] w-full relative'>
                            <div className='grid grid-cols-5 items-center py-3 w-full px-5'>
                                <div className='border-r border-[#01008036] py-1 cursor-pointer relative'>
                                    <div onClick={() => setfromLocation(!fromLocation)} className='flex items-center gap-1 '>
                                        <img className='w-6 h-6' src={'/Assets/Icons/herolocation.svg'} alt="" />
                                        <div>
                                            <p className='text-[#000000] text-[12.5px]'>From</p>
                                            <p className='text-[#9E9E9E] text-[10px]'>Where You Start ?</p>
                                        </div>
                                    </div>
                                    {fromLocation ?
                                        <div className='absolute bg-[#F6F6F6] top-[100%] right-0 px-3 py-2 rounded shadow-lg shadow-[#00000021]'>
                                ...
                                <div className='border-r border-[#01008036] py-1 cursor-pointer relative'>
                                    <div onClick={() => setToLocation(!toLocation)} className='flex items-center gap-1'>
                                        <img className='w-6 h-6' src={'/Assets/Icons/herolocation.svg'} alt="" />
                                        <div>
                                            <p className='text-[#000000] text-[12.5px]'>To</p>
                                            <p className='text-[#9E9E9E] text-[10px]'>Where You Going ?</p>
                                        </div>
                                    </div>
                                    {toLocation ?
                                        <div className='absolute bg-[#F6F6F6] top-[100%] right-0 px-3 py-2 rounded shadow-lg shadow-[#00000021]'>
                                ...
                                <div className='border-r border-[#01008036] py-1 cursor-pointer relative'>
                                    <div onClick={() => setFlightDate(!FlightDate)} className='flex items-center justify-center gap-1'>
                                        <img className='w-6 h-6' src={'/Assets/Icons/HeroDate.svg'} alt="Date Icon" />
                                        <div>
                                            <p className='text-[#000000] text-[12.5px]'>Date</p>
                                            <p className='text-[#9E9E9E] text-[10px]'>d / m / year</p>
                                ...
                                <div className='py-1 cursor-pointer relative'>
                                    <div onClick={() => setFlightNop(!flightNop)} className='flex items-center justify-center gap-1'>
                                        <img className='w-6 h-6' src={'/Assets/Icons/HeroBag.svg'} alt="" />
                                        <div>
                                            <p className='text-[#000000] text-[12.5px]'>No. of Person</p>
                                            <p className='text-[#9E9E9E] text-[10px]'>2 Adult 1 Child</p>

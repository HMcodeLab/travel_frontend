...
const EnquiryForm = ({setEnquiryModal}) => {
    return (
        <div className="w-[580px] min-h-[350px]mx-auto border-[1.5px] border-[#E0DEDE] rounded-lg font-[Merriweather-sans] absolute z-[50] top-40 left-[27%] fadeInTop">
                <div className="w-[571px] min-h-[342px] bg-white m-[3px] rounded-md flex flex-col gap-2 px-6 py-4">
                    ...
                    <div>
                        <button className="flex items-center gap-2 px-6 py-2 bg-[#CA1C26] text-white text-[14px] rounded">
                            <img src={"/Assets/Icons/map.svg"} alt="" className="w-[26px] h-[24.82px]"/>
                            <p>Book Now</p>
                        </button>
                    </div>
                </div>

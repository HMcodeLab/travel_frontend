                                ...
                                <div className="features">
                                    ...
                                    <div className="col-md-4 text-center mb-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="20" height="20" viewBox="0 0 15 15">
                                            <g fill="none">
                                                <path fillRule="evenodd" clipRule="evenodd" d="M4 0h7v1h3v12.5a1.5 1.5 0 0 1-1.5 1.5h-10A1.5 1.5 0 0 1 1 13.5V1h3V0zm1 1h5v1.5a.5.5 0 0 1-.5.5h-4a.5.5 0 0 1-.5-.5V1zm2.024 10.232l3.852-4.403l-.752-.658l-3.148 3.598l-1.622-1.623l-.708.708l2.378 2.378z" fill="#ff8913"></path>
                                            </g>
                                        </svg>
                                    ...
                                    <div className="col-md-4 text-center mb-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20">
                                            <path d="M16 2h4v15a3 3 0 0 1-3 3H3a3 3 0 0 1-3-3V0h16v2zm0 2v13a1 1 0 0 0 1 1a1 1 0 0 0 1-1V4h-2zM2 2v15a1 1 0 0 0 1 1h11.17a2.98 2.98 0 0 1-.17-1V2H2zm2 8h8v2H4v-2zm0 4h8v2H4v-2zM4 4h8v4H4V4z" fill="#ff8913"></path>
                                        </svg>
                ...
                <div className="form_footer">
                    <div className="left_footer_content">
                        <div className="col-md-12 text-center call_dat12">
                            ...
                            <p> <FaEnvelope /> sales@eligocs.com </p>
                        </div>
                    </div>
